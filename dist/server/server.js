...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-1pjTmCXk.js");
...
async function getEntries() {
  if (cachedRouterEntry === null) {
    cachedRouterEntry = await import("./assets/router-BF5dxWeQ.js").then((n) => n.r);
  }
